...
<body  id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
   ...
   <!--Delete the no-image class from your code, all css in this example is merely to beautify the results on this page, and is not required for the modal carousels to work-->
	...
	<div class="container">
		...
		<div class="row">
            <div class="col-lg-5 col-sm-6">
				<div class="content3">
					<h3 class="section-heading slideanim"><?php echo $o['o_title'];?></h3>
					<hr class="section-heading-spacer slideanim">
					<div class="clearfix"></div>
					<p class="lead slideanim"><?php echo $o['o_description'];?></p>
            ...
            <div class="col-lg-5 col-lg-offset-2 col-sm-6 slideanim">
                <ul class="grid cs-style">
					<li>
						<figure>
							<img id="image2" src="<?php echo base_url();?>images/opportunity/<?php echo $o['image'];?>" alt="" class="img-responsive">
